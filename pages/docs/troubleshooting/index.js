...
// CHANGE INFO HERE
const id = "troubleshooting" // due to some problems, this MUST be the same as the folder name
const name = "Troubleshooting"
const description = "Have a problem with Wizard? Find a solution here."
// CHANGE INFO HERE
