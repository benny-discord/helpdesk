...
// CHANGE INFO HERE
const id = "faq-examples" // due to some problems, this MUST be the same as the folder name
const name = "F.A.Q. & Examples"
const description = "Commonly asked questions as well as common usage examples can be found here."
// CHANGE INFO HERE
